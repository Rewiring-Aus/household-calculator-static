...
import ChevronUp from "src/assets/icons/chevron-up.svg?react";
...
const MobileSavingsDrawer = (savings: SavingsDrawerProps) => {
  const { results, loadingData, appliances, numEVsToBuy, household } = savings;
  ...
  return (
    ...
    >
      <StyledBox
        className="MobileSavingsDrawer-Toolbar"
        theme={theme}
        sx={{
          position: "fixed",
